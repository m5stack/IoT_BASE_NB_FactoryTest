...
class TFT_eSprite : public TFT_eSPI {
 ...
 public:
  ...
  void     drawColorBitmap(int32_t x0, int32_t y0, int32_t w, int32_t h,const uint8_t *data, uint32_t color, uint32_t bkcolor);
  void     drawColorBitmapAlpha(int32_t x0, int32_t y0, int32_t w, int32_t h,const uint8_t *data, uint32_t color, uint32_t bkcolor);
